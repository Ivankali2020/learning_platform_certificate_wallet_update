                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <li class="nav-item  animate__animated animate__fadeInLeftBig  " style="--animate-duration: 5s" >
                                <a class="nav-link " href="{{ route('user.enrollment') }}">
                                    <span >
                                        <img src="{{ asset('photo/course.png') }}" width="25px" alt="">
                                        <sup class="icon-gradient bg-premium-dark ">{{ count(\App\Models\Enrollment::where('user_id',\Illuminate\Support\Facades\Auth::id())->get()) ?? ''}} </sup>
                                    </span>
                                </a>
                            </li>
